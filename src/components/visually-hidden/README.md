...
There are no content elements specific for this component. Follow any guidelines appropriate to the element being 
hidden.
...
Always provide a heading for a major page section such as a card. In rare cases the heading is visually redundant and
the meaning is conveyed by context. Rather than omit the heading, wrap the heading in the visually hidden component.
